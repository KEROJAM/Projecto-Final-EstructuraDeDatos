...
public class Login {
    ...
    private void cargarUsuariosPredefinidos() {
        ...
        for (int i = 0; i < 5; i++) {
            Cliente cliente = new Cliente(i + 1, nombres[i], saldos[i], 0, tarjetas[i], contraseñas[i], false);   clientesTable.put(tarjetas[i], cliente);
    ...
    private void registrarNuevoUsuario(BufferedReader reader) {
        try {
            ...
            Cliente nuevoCliente = new Cliente(nuevoID, nombreCompleto, 1000, 0, tarjetaUsuario, contraseña, false);
